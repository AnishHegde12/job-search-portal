...
const SignUp = () => {
    return <div className="w-1/2 px-20 flex flex-col justify-center gap-3">
        ...
        <PasswordInput leftSection={<IconLock size={18} stroke={1.5} />} label="Password" withAsterisk placeholder="Enter Password" />
        <PasswordInput leftSection={<IconLock size={18} stroke={1.5} />} label="Confirm Password" withAsterisk placeholder="Confirm Password" />
