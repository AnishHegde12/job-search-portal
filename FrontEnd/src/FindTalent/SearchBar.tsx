    ...
    return (
        <div className="flex px-5 py-8 items-center !text-mine-shaft-100">
            <div className="flex items-center">
                ...
                <Input variant="unstyled" placeholder="Talent Name" classNames={{
                    input: '!placeholder-mine-shaft-200 placeholder:text-lg',
                }} />
            </div>
            {
            ...
            <div className="w-1/5 [&_.mantine-Slider-label]:!translate-y-10">
                ...
                <RangeSlider color="brightSun.4" size="xs" value={value} labelTransitionProps={{
                    transition: 'skew-down', duration: 150, timingFunction: 'linear',
