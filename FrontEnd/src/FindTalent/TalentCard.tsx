...
const TalentCards = (props: any) => {
    ...
    return (
        <div className="bg-mine-shaft-900 p-4 w-80 flex flex-col gap-3 rounded-xl hover:shadow-[0_0_5px_1px_yellow] !shadow-bright-sun-400">
            <div className="flex justify-between">
                <div className="flex gap-2 items-center">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="text-md text-mine-shaft-300">{props.role} &bull; {props.company}</div>
                    </div>
                </div>
            ...
            <Divider size="xs" color="mineShaft.7" />
            {
                props.invited ? <div className="flex gap-1 text-mine-shaft-200 text-sm items-center">
                    <IconCalendarMonth stroke={1.5} />Interview: August 27, 2024 10:00AM
            ...
            <div className="flex [&>*]:w-1/2 [&>*]:p-1">
                {
                    !props.invited && <>
                        ...
                        <div>
                            {props.posted ? <Button onClick={open} rightSection={<IconCalendarMonth className="w-5 h-5" />} fullWidth color="brightSun.4" variant="light">Schedule</Button> : <Button fullWidth color="brightSun.4" variant="light">Message</Button>}
                        </div>
                    </>
                }
                {
            ...
            <Modal opened={opened} onClose={close} title="Schedule Interview" centered>
                <div className="flex flex-col gap-3">
                    ...
                    <Button fullWidth color="brightSun.4" variant="light">Schedule</Button>
                </div>
            </Modal>
        </div>
    )
