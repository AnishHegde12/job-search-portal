...
const Working = () => {
    return (
        <div className="mt-20 pb-5">
            ...
            <div className="text-mine-shaft-300 text-lg mx-auto mb-10 text-center w-1/2">Effortlessly navigate through the process and land your dream job.</div>
            <div className="flex gap-5 px-16 justify-between items-center">
                <div className="relative">
                    ...
                    <div className="w-36 flex top-[15%] right-0 absolute flex-col items-center gap-1 border border-bright-sun-400 rounded-xl py-3 px-1 backdrop-blur-md">
                        <Avatar className="!h-16 !w-16" src="avatar3.png" alt=""/>
                        <div className="text-sm text-semibold text-mine-shaft-200 text-center">Complete your profile</div>
