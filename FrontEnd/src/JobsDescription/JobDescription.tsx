    ...
    return <div className="w-2/3">
        <div className="flex justify-between">
            ...
            <div className="flex flex-col gap-2 items-center">
                ...
                {props.edit?<Button color="red.5" size="sm" variant="outline">Delete</Button>:<IconBookmark className="text-bright-sun-400 hover:cursor-pointer" />}
            </div>
        </div>
        <Divider my="xl" />
        <div className="flex justify-between">
        ...
        <div>
            ...
            <div className="flex flex-wrap gap-2">
                {
                    skills.map((skill, index) => <ActionIcon key={index} className="!h-fit !w-fit font-medium !text-sm" color="brightSun.4" variant="light" p="xs" radius="xl" aria-label="Settings">
                        {skill}
                    </ActionIcon>)
                }
            </div>
        ...
        <div>
            ...
            <div className="flex justify-between mb-3">
                ...
                <Link to="/company"><Button color="brightSun.4" variant="light">Company Page</Button></Link>                </div>
        </div>
            <div>
                <div className="text-mine-shaft-300 text-justify">Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe, tempore incidunt, aperiam excepturi omnis provident quod, alias id ipsum est numquam quia praesentium impedit iusto recusandae nesciunt distinctio? Consequuntur qui dicta cum quis mollitia ipsa, nam fugit eveniet iure similique?</div>
            </div>    
    </div>
}
